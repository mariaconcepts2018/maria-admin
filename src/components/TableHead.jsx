...
const company = ["mariaconcepts", "serahconstruction"];
    ...
    <>
      <thead>
        <tr>
          ...
          <th className="p-4 transition-colors border-y border-blue-gray-100 bg-blue-gray-50/50 hover:bg-blue-gray-50">
            <div className="relative flex items-center justify-between gap-2 font-sans text-sm antialiased font-normal leading-none">
              Project
              <button
                className={`${
          ...
          <th className="p-4 transition-colors border-y border-blue-gray-100 bg-blue-gray-50/50 hover:bg-blue-gray-50">
            <div className="relative flex items-center justify-between gap-2 font-sans text-sm antialiased font-normal leading-none text-blue-gray-900">
              Source
              <button
                className={`${
          ...
          <th className="p-4 transition-colors border-y border-blue-gray-100 bg-blue-gray-50/50 hover:bg-blue-gray-50">
            <div className="relative flex items-center justify-between gap-2 font-sans text-sm antialiased font-normal leading-none text-blue-gray-900">
              ...
              <button
                className={`${
                  filterBy.field === "company"
                    ? "bg-black text-white"
                    : "bg-none text-black"
                } rounded-full p-1 cursor-pointer`}
                onClick={() =>
                  setoptions({ field: "company", show: !options.show })
                }
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div
                className={`${
                  options.field === "company" && options.show
                    ? "scale-100"
                    : "scale-0 -translate-y-1/2 translate-x-1/2"
                } z-100 transition transform flex min-w-[240px] top-0 right-6 flex-col gap-1 p-1.5 absolute p-4 font-sans text-sm font-normal break-words whitespace-normal bg-white border rounded-lg shadow-lg w-max border-blue-gray-50 text-blue-gray-500 shadow-blue-gray-500/10 focus:outline-none`}
              >
          ...
          <th className="p-4 transition-colors border-y border-blue-gray-100 bg-blue-gray-50/50 hover:bg-blue-gray-50">
            <p className="flex items-center justify-between gap-2 font-sans text-sm antialiased font-normal leading-none text-blue-gray-900">
              Modified By
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
